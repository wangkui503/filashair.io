...
<button 
        onClick={()=>tabSwitch('home','auto')}
         className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group " + (currentPage==='home' ? 'text-blue-600 border-blue-600':'')}>
            <svg className="w-14 h-14 text-slate-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill={currentPage==='home' ?"#137ED9":"currentColor"} viewBox="0 0 20 20">
        ...
        onClick={()=>tabSwitch('messages','auto')}
         className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group " + (currentPage==='messages' ? 'text-blue-600 border-blue-600':'')}>
            <svg className="w-14 h-14 text-slate-500 " viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <title>send-email</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g transform="translate(-570.000000, -257.000000)" fill={currentPage==='messages' ?"#137ED9":"currentColor"}> <path d="M580.407,278.75 C581.743,281.205 586,289 586,289 C586,289 601.75,258.5 602,258 L602.02,257.91 L580.407,278.75 L580.407,278.75 Z M570,272 C570,272 577.298,276.381 579.345,277.597 L601,257 C598.536,258.194 570,272 570,272 L570,272 Z"> </path> </g> </g> </g></svg>
            <span className="py-1 text-sm text-slate-500 ">
              Comms
              </span>
          </button>
        ...
        onClick={()=>tabSwitch('transfers','auto')}
         className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group " + (currentPage==='transfers' ? 'text-blue-600 border-blue-600':'')}>
          ...
          className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group " + (currentPage==='network' ? 'text-blue-600 border-blue-600':'text-slate-500')}>
            <svg className="w-14 h-14 text-slate-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill={currentPage==='network' ?"#137ED9":"currentColor"} className="bi bi-people-fill"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path> <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"></path> <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"></path> </g></svg>
            </svg>
        ...
        onClick={()=>tabSwitch('shares','auto')}
         className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group " + (currentPage==='shares' ? 'text-blue-600 border-blue-600':'')}>
            <svg className="w-14 h-14 text-slate-500 " viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path fill-rule="evenodd" clip-rule="evenodd" d="M13.803 5.33333C13.803 3.49238 15.3022 2 17.1515 2C19.0008 2 20.5 3.49238 20.5 5.33333C20.5 7.17428 19.0008 8.66667 17.1515 8.66667C16.2177 8.66667 15.3738 8.28596 14.7671 7.67347L10.1317 10.8295C10.1745 11.0425 10.197 11.2625 10.197 11.4872C10.197 11.9322 10.109 12.3576 9.94959 12.7464L15.0323 16.0858C15.6092 15.6161 16.3473 15.3333 17.1515 15.3333C19.0008 15.3333 20.5 16.8257 20.5 18.6667C20.5 20.5076 19.0008 22 17.1515 22C15.3022 22 13.803 20.5076 13.803 18.6667C13.803 18.1845 13.9062 17.7255 14.0917 17.3111L9.05007 13.9987C8.46196 14.5098 7.6916 14.8205 6.84848 14.8205C4.99917 14.8205 3.5 13.3281 3.5 11.4872C3.5 9.64623 4.99917 8.15385 6.84848 8.15385C7.9119 8.15385 8.85853 8.64725 9.47145 9.41518L13.9639 6.35642C13.8594 6.03359 13.803 5.6896 13.803 5.33333Z" fill={currentPage==='shares' ?"#137ED9":"currentColor"}></path> </g></svg>
            <span className="whitespace-nowrap py-1 text-sm text-slate-500 ">
              Shares
              </span>
          </button>

        {
          ...
          className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group "+ (currentPage==='storages' ? 'text-blue-600 border-blue-600':'')}>
            <svg className="w-14 h-14 text-slate-500 " fill={currentPage==='storages' ?"#137ED9":"currentColor"} viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <title>storage-solid</title> <path className="clr-i-solid clr-i-solid-path-1" d="M17.91,18.28c8.08,0,14.66-1.74,15.09-3.94V8.59c-.43,2.2-7,3.94-15.09,3.94A39.4,39.4,0,0,1,6.25,11V9a39.4,39.4,0,0,0,11.66,1.51C26,10.53,32.52,8.79,33,6.61h0C32.8,3.2,23.52,2.28,18,2.28S3,3.21,3,6.71V29.29c0,3.49,9.43,4.43,15,4.43s15-.93,15-4.43V24.09C32.57,26.28,26,28,17.91,28A39.4,39.4,0,0,1,6.25,26.52v-2A39.4,39.4,0,0,0,17.91,26C26,26,32.57,24.28,33,22.09V16.34c-.43,2.2-7,3.94-15.09,3.94A39.4,39.4,0,0,1,6.25,18.77v-2A39.4,39.4,0,0,0,17.91,18.28Z"></path> <rect x="0" y="0" width="36" height="36" fill-opacity="0"></rect> </g></svg>
          ...
          <button 
          onClick={() => signOut()}
          className={"inline-flex flex-col items-center justify-center  pb-2 pt-3 px-3 border-transparent border-b-2 md:hover:text-blue-600  group "}>
          <svg className="w-14 h-14 text-slate-500 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
