...
export default function TransferNav({page}) {   
    return (
    ...
    <ul className="flex flex-wrap -mb-px">        
      ...
      onClick={()=>tabSwitch('transferListRef', 'auto')}
          className={`flex flex-row gap-2 inline-block p-4 ${page==='transferListRef' ? 'text-blue-600 border-b-2 border-blue-600 active' : ''} rounded-t-lg `}
