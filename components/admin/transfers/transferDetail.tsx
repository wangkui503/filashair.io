...
export default function TransferDetail({detailTransfer, back}) {    
  ...
  const xfers = detailTransfer?.xfers?? JSON.parse(detailTransfer?.specs)
  

  console.log("detailTransfer---", detailTransfer, xfers)
...
<SpeedChart xfers={xfers} status={detailTransfer?.status} />
</div>
