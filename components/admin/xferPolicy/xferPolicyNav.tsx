...
export default function XferPolicyNav({page}) {   
    return (
        <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
    <ul className="flex flex-wrap -mb-px">        
      <li className="mr-2">
      <button 
      onClick={()=>tabSwitch('policiesList', 'auto')}
      ...
      <li className="mr-2">
        <button 
        onClick={()=>tabSwitch('xferPolicyPlugRef', 'auto')}
      ...
      <li className="mr-2">
        <button 
        onClick={()=>tabSwitch('xferPolicyNewRef', 'auto')}
            className={`flex flex-row gap-2 inline-block p-4 rounded-t-lg md:hover:text-blue-600 `}
