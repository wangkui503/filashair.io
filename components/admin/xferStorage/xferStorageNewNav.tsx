...
export default function XferStorageNewNav({page, title, back}) {   
    return (
    ...
    <ul className="flex flex-wrap -mb-px">        
          ...
          <button
            ...
            onClick={()=>tabSwitch(title+'xferStorageListRef', 'auto')}
            >
          <span>Storages</span>
          </button>
          </li>    
      ...
      <li className="mr-2">
      <button 
      onClick={()=>tabSwitch(title+'xferStorageNewRef', 'auto')}
